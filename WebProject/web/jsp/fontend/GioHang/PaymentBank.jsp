                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="checkout-wrapper bg--2">
                                    <f:form class="form" action="finishCheckoutPaymentBank.htm" commandName="orInfor" >
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="checkout-form">
                                                    ...
                                                    <div class="form-row mb--30">
                                                        <div class="form__group col-12">
                                                            ...
                                                            <input value="${orInfor.name}" type="text" name="name1" id="name1" class="form__input form__input--2" readonly="true">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row mb--30">
                                                        <div class="form__group col-12">
                                                            ...
                                                            <input type="text" value="${orInfor.address}" readonly="true" name="billing_streetAddress" id="billing_streetAddress" class="form__input form__input--2">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row mb--30">
                                                        <div class="form__group col-md-6 mb-sm--30">
                                                            ...
                                                            <input type="text" value="${orInfor.getPhone()}" name="billing_phone" id="billing_phone" class="form__input form__input--2" readonly="true">
                                                        </div>
                                                        <div class="form__group col-md-6">
                                                            <label for="billing_email" class="form__label">Email: <span>*</span></label>
                                                            <input type="email" readonly="true" value="${orInfor.email}" name="billing_email" id="billing_email" class="form__input form__input--2">
                                                        </div>
                                                    </div>
                                                    <div class="form-row mb--30">
                                                        <
                                                         <div class="form__group col-12">
                                                            ...
                                                            <input type="text" value="<c:if test="${orInfor.paymentId==1}">Thanh toán khi giao hàng</c:if><c:if test="${orInfor.paymentId==2}">Thanh toán qua tài khoản ngân hàng</c:if>" name="billing_date" id="billing_date" class="form__input form__input--2" readonly="true">
                                                        </div>

                                                        </div>
                                                         <div class="form-row mb--30">
                                                        <div class="form__group col-md-6 mb-sm--30">
                                                            <label for="billing_phone" class="form__label">Số tài khoản</label>
                                                            <input type="text"  name="AccNo" id="billing_phone" class="form__input form__input--2" >
                                                        </div>
                                                        <div class="form__group col-md-6">
                                                            <label for="billing_email" class="form__label">Chủ tài khoản <span>*</span></label>
                                                            <input type="text"   name="AccName" id="billing_email" class="form__input form__input--2">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <tbody>
                                                                <c:forEach items="${listCart}" var="cart">
                                                                    <tr>
                                                                        ...
                                                                        <td><fmt:formatNumber maxFractionDigits="3" value="${(cart.product.getProductPriceAfterDiscount())*cart.quantity}"></fmt:formatNumber>đ</td>
                                                                        </tr>
                                                                </c:forEach>
                                                            </tbody>
                                                            <tfoot>
                                                                ...
                                                                <tr class="order-total">
                                                                    <th>Tổng tiền</th>
                                                                    <td><span class="order-total-ammount"><fmt:formatNumber maxFractionDigits="3" value="${orInfor.totalAmount}"></fmt:formatNumber>đ</span></td>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
                                                        </div>
