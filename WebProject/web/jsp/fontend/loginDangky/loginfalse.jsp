<%-- 
    Document   : error
    Created on : Feb 13, 2019, 9:19:20 PM
    Author     : Đức Huy
--%>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-7 col-lg-8 text-center">
                            <div class="error">
                                ...
                                <p>Bạn đã đăng nhập thất bại, vui lòng kiểm tra lại</p>
                                
                                <a href="<%=request.getContextPath()%>/initDangky.htm" class="btn btn-4 btn-style-3">Quay trờ lại trang đăng nhập</a>
                            </div>
                        </div>
                    </div>
                </div>
